    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.ImageField(blank=True, default='/media/views/default.jpg', null=True, upload_to='media/views')),
                ('image2', models.ImageField(blank=True, default='/media/views/default.jpg', null=True, upload_to='media/views')),
                ('image3', models.ImageField(blank=True, default='/media/views/default.jpg', null=True, upload_to='media/views')),
