    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.ImageField(blank=True, default='views/download_5_ZjG0q06.jfif', null=True, upload_to='views')),
                ('image2', models.ImageField(blank=True, default='views/download_5_ZjG0q06.jfif', null=True, upload_to='views')),
                ('imag3', models.ImageField(blank=True, default='views/download_5_ZjG0q06.jfif', null=True, upload_to='views')),
